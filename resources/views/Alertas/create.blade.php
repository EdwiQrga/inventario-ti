...
<head>
    ...
    <title>Nueva Alerta - Inventario TI</title>
...
<!-- Sidebar similar al de tu vista index -->
<div class="flex">
    <!-- Sidebar -->
    ...
    <div class="flex-1">
        ...
        <header class="bg-white/80 dark:bg-gray-900/80 backdrop-blur-sm border-b border-gray-200 dark:border-gray-800 px-6 py-4 sticky top-0">
            <div class="flex justify-between items-center">
                <h1 class="text-xl font-semibold text-gray-900 dark:text-white">Configurar Nueva Alerta</h1>
                    ...
                    <form action="{{ route('alertas.store') }}" method="POST">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                            ...
                            <div>
                                ...
                                <input type="date" name="fecha_alerta" required
                                       class="w-full h-10 px-3 rounded-lg bg-white dark:bg-gray-800 border border-gray-300 dark:border-gray-700 focus:ring-2 focus:ring-primary/50 focus:border-primary transition-colors"
                                       value="{{ date('Y-m-d') }}">
                            </div>
                        ...
                        <div class="mb-6">
                            ...
                            <textarea name="descripcion" required rows="4"
                                      ...
                                      placeholder="Describa los detalles de la alerta..."></textarea>
                        </div>
