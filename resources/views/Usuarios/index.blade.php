...
<head>
    ...
    <title>Gestión de Usuarios - Inventario TI</title>
...
<div class="relative flex h-auto min-h-screen w-full group/design-root overflow-x-hidden">
    <div class="layout-container flex h-full grow flex-row">
        ...
        <div class="flex flex-col flex-1">
            <!-- Header -->
            <header class="flex items-center justify-between whitespace-nowrap border-b border-solid border-gray-200 dark:border-gray-800 px-6 sm:gap-4 lg:px-10 py-4 bg-white/80 dark:bg-gray-900/80 backdrop-blur-sm sticky top-0 z-10">
                    ...
                    <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
                        ...
                        <div class="lg:col-span-2 flex flex-col gap-6">
                            <div class="flex flex-wrap justify-between items-center gap-4">
                                ...
                                <button onclick="resetForm()" class="flex min-mw-[40px] max-w-[480px] cursor-pointer items-center justify-center gap-2 overflow-hidden rounded-lg h-10 px-4 bg-primary text-white text-sm font-medium hover:bg-primary/90 transition-all shadow-sm">
                            ...
                            <div class="rounded-xl border border-gray-200 dark:border-gray-800 bg-white dark:bg-gray-900 shadow-sm overflow-hidden">
                                ...
                                <div class="p-4">{{ $usuarios->appends(request()->query())->links('pagination::tailwind') }}</div>
                            </div>
                        </div>
