...
document.addEventListener('DOMContentLoaded', function() {
    ...
    // 5. Botón de prueba para debug (solo en desarrollo)
    @if(app()->environment('local'))
    const debugButton = document.createElement('button');
    debugButton.textContent = '🧪 Probar Exportación';
    debugButton.className = 'fixed bottom-4 right-4 bg-blue-500 text-white px-4 py-2 rounded-lg z-50 shadow-lg';
    debugButton.onclick = function() {
        const url = '{{ route("reportes.export") }}?reporte=inventario_impresoras&formato=xlsx';
        console.log('🔗 URL de prueba para impresoras:', url);
